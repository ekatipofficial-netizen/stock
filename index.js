...
// ปลายทางสำหรับดูสถานะด้วยตาคน เปิดในเบราว์เซอร์แล้วเห็นว่าตื่นมานานเท่าไหร่
app.get('/health', (req, res) => {
  res.status(200).json({ ok: true, uptimeSec: Math.round(process.uptime()) });
});

// ปลายทางสำหรับตัวปลุกอัตโนมัติโดยเฉพาะ
// 204 แปลว่า "สำเร็จ แต่ไม่มีเนื้อหา" ส่งกลับ 0 ไบต์ ไม่มีแม้แต่ตัวอักษรเดียว
// บริการตั้งเวลาบางเจ้าจำกัดขนาดข้อมูลที่ยอมรับได้ การไม่ส่งอะไรเลยจึงปลอดภัยที่สุด
